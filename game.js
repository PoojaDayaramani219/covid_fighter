//added some interesting features such as player movement and health, collision detection, and a game-over condition.
...
function update() {    
    ...
    // Check overlap between player & gem
...
load_images();
init();
var f = setInterval(gameloop, 100); // milliseconds
